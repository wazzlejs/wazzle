        ...
        .then(function (updatedModules) {
          ...
          return module.hot
            .apply({
              ...
              onUnaccepted(data) {
                //log('warn', '\u0007Ignored an update to unaccepted module ' + data(x=>x.chain.join(' -> ')));
              },
            })
